...
class NeuralNetwork(Model):
    ...
    def set_default_hyperparameters(self, nn_search_space=1):
        ...
        if nn_search_space == 1:
            ...
            'scale_X': hp.choice('scale_X',
                     ...
                     {'scale_X': 'mm11', 'activation': hp.choice('activ4', ['relu'])},
                     {'scale_X': 'mm11', 'activation': hp.choice('activ5', ['relu'])}
                     ]),
    ...
    def optimize_model(self):
        ...
        for i in learning_rates:
            ...
            test_error, val_error = self.build_model(self.optimal_hyperparameters, maxit=5000, val_freq=10, es_patience=30, opt='lbfgs', tol=0.5,  decay=False, verbose=False, precision=precision)
